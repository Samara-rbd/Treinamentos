...
function nexQuestion(question_number){
...
submit1.addEventListener('clik', function(){
    nexQuestion(2);
    growProgressBar('40%');
})
submit2.addEventListener('clik', function(){
    nexQuestion(3);
    growProgressBar('60%');
})
submit3.addEventListener('clik', function(){
    nexQuestion(4);
    growProgressBar('80%');
})
submit4.addEventListener('clik', function(){
    nexQuestion(5);
    growProgressBar('100%');
})
submit5.addEventListener('clik', function(){
    nexQuestion(6);
